...
class WebRequest(object):
    ...
    def get(self, url, header=None, retry_time=5, timeout=30, retry_flag=list(), retry_interval=5):
        """
        get method
        ...
        :param retry_flag: if retry_flag in html.content then do retry
