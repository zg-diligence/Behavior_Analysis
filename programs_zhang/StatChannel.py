...
ChannelNames = {'CCTV-5':'CCTV=5','CCTV-5高清':'CCTV-5 高清','CCTV-5高清Dolby':'CCTV=5高清Dolby','CCTV5+':'CCTV5+体育赛事','CCTV5+Dolby':'CCTV5+ Dolby'}#{'CCTV-4':'CCTV-4高清','江苏卫视':'江苏卫视高清','湖南卫视':'湖南卫视高清'}

#for ChannelName, ChannelName2 in ChannelNames.items():
for i_day in range(1,16):#range(1,4):
    for i_hour in range(0,24):
        #freq = {'CCTV-1':set(),'北京卫视':set(),'黑龙江卫视':set(),'湖南卫视':set(),'江苏卫视':set(),'浙江卫视':set()}
        freq = {}
        ...
        outpath = os.path.join(base_dir, "StatNomal_HD_DolbyCCTV5")
