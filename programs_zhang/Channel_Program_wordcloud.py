...
for i_day in [8,11]:#range(1,4):
    programs = []
    for i_hour in range(10,13):
    ...
    outpath = os.path.join(base_dir, "ForWordCloud")
    ...
    #     fp.write(channel+'\n')
    # fp.close()
    fp = open(unicode(outpath + '/'+str(i_day)+'_programs10-13'+'.txt','utf-8'), 'w')
