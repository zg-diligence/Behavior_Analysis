...
res_fp = open('result_num_user.txt','a')
res_fp.write('num_user\trunning_time\n')

for num_user in range(50,401,50):
	start = datetime.now()
	############
	for user in TargetUser[:num_user]:
